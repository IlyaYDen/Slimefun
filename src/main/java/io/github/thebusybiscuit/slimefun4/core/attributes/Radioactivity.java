...
public enum Radioactivity {
    ...
    public String getLore() {
        return ChatColor.GREEN + "\u2622" + ChatColor.GRAY + " Уровень радиации: " + color + toString().replace('_', ' ');
