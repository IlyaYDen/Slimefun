...
public interface GEOResource extends Keyed {
    ...
    default String getName(@Nonnull Player p) {
        String name = SlimefunPlugin.getLocalization().getResourceString(p, "ресурсы." + getKey().getNamespace() + "." + getKey().getKey());
        //edited String name = SlimefunPlugin.getLocalization().getResourceString(p, "resources." + getKey().getNamespace() + "." + getKey().getKey());
