...
public class GEOResourceGenerationEvent extends Event {
    ...
    public void setValue(int value) {
        if (value < 0) {
            throw new IllegalArgumentException("Вы не можете установить для георесурсов отрицательное значение.");//edited You cannot set a GEO-Resource supply to a negative value
        }
