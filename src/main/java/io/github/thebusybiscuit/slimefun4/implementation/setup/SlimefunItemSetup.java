...
public final class SlimefunItemSetup {
    ...
    public static void setup(@Nonnull SlimefunPlugin plugin) {
        ...
        new ItemStack[] {null, new ItemStack(Material.REDSTONE), null, SlimefunItems.ZINC_INGOT, SlimefunItems.SULFATE, /*SlimefunItems.COPPER_INGO*/ new ItemStack(Material.COPPER_INGOT), SlimefunItems.ZINC_INGOT, SlimefunItems.SULFATE, /*SlimefunItems.COPPER_INGO*/ new ItemStack(Material.COPPER_INGOT)})
        .register(plugin);
        ...
        new SlimefunItem(categories.resources, SlimefunItems.LEAD_ORE, RecipeType.ORE_DROP,
                new ItemStack[] {null, null, null, null, new ItemStack(Material.IRON_PICKAXE), null, null, null, null})
                .register(plugin);
        new SlimefunItem(categories.resources, SlimefunItems.TIN_ORE, RecipeType.ORE_DROP,
                new ItemStack[] {null, null, null, null, new ItemStack(Material.IRON_PICKAXE), null, null, null, null})
                .register(plugin);
        new SlimefunItem(categories.resources, SlimefunItems.ALUMINIUM_ORE, RecipeType.ORE_DROP,
                new ItemStack[] {null, null, null, null, new ItemStack(Material.IRON_PICKAXE), null, null, null, null})
                .register(plugin);
        new SlimefunItem(categories.resources, SlimefunItems.NICKEL_ORE, RecipeType.ORE_DROP,
                new ItemStack[] {null, null, null, null, new ItemStack(Material.IRON_PICKAXE), null, null, null, null})
                .register(plugin);
        //URANIUM_ORE
        new SlimefunItem(categories.resources, SlimefunItems.SILVER_ORE, RecipeType.ORE_DROP,
                new ItemStack[] {null, null, null, null, new ItemStack(Material.IRON_PICKAXE), null, null, null, null})
                .register(plugin);
        new SlimefunItem(categories.resources, SlimefunItems.URANIUM_ORE, RecipeType.ORE_DROP,
                new ItemStack[] {null, null, null, null, new ItemStack(Material.IRON_PICKAXE), null, null, null, null})
                .register(plugin);
        ...
        new ItemStack[] {SlimefunItems.DAMASCUS_STEEL_INGOT, SlimefunItems.DURALUMIN_INGOT, SlimefunItems.COMPRESSED_CARBON, SlimefunItems.ALUMINUM_BRONZE_INGOT, null, null, null, null, null}, 370, "pickaxe")
        .register(plugin);
        ...
        new ItemStack[] {SlimefunItems.COPPER_DUST, SlimefunItems.TIN_DUST, /*SlimefunItems.COPPER_INGOT*/ new ItemStack(Material.COPPER_INGOT), null, null, null, null, null, null})
        .register(plugin);
        ...
        new ItemStack[] {SlimefunItems.COPPER_DUST, SlimefunItems.ZINC_DUST, /*SlimefunItems.COPPER_INGO*/ new ItemStack(Material.COPPER_INGOT), null, null, null, null, null, null})
        .register(plugin);
...
//edited end
        ...
        new ItemStack[] {null, null, null, /*SlimefunItems.COPPER_INGO*/ new ItemStack(Material.COPPER_INGOT), /*SlimefunItems.COPPER_INGO*/ new ItemStack(Material.COPPER_INGOT), /*SlimefunItems.COPPER_INGO*/ new ItemStack(Material.COPPER_INGOT), null, null, null},
        ...
        new SlimefunItemStack(SlimefunItems.WITHER_PROOF_OBSIDIAN, 4), 370, "pickaxe")
        .register(plugin);
        ...
        new ItemStack[] {null, new ItemStack(Material.FURNACE), null, SlimefunItems.GILDED_IRON, SlimefunItems.HEATING_COIL, SlimefunItems.GILDED_IRON, SlimefunItems.GILDED_IRON, SlimefunItems.ELECTRIC_MOTOR, SlimefunItems.GILDED_IRON},
                44,1022, new int[]{11, 12}, new int[]{25, 26},270,"pickaxe")
        .setCapacity(64)
        ...
        new ItemStack[] {null, SlimefunItems.ELECTRIC_MOTOR, null, SlimefunItems.GILDED_IRON, SlimefunItems.ELECTRIC_FURNACE, SlimefunItems.GILDED_IRON, SlimefunItems.GILDED_IRON, SlimefunItems.HEATING_COIL, SlimefunItems.GILDED_IRON},
                44, 1034, new int[]{11, 12}, new int[]{25, 26},270,"pickaxe")
        .setCapacity(128)
        ...
        new ItemStack[] {null, SlimefunItems.ELECTRIC_MOTOR, null, SlimefunItems.STEEL_INGOT, SlimefunItems.ELECTRIC_FURNACE_2, SlimefunItems.STEEL_INGOT, SlimefunItems.GILDED_IRON, SlimefunItems.HEATING_COIL, SlimefunItems.GILDED_IRON},
                44, 1037, new int[]{11, 12}, new int[]{25, 26},270,"pickaxe")
        .setCapacity(128)
...
////
        ...
        .setProcessingSpeed(5)//(10)
        .register(plugin);

        new ElectricDustWasher(categories.electricity, SlimefunItems.ELECTRIC_DUST_WASHER, RecipeType.ENHANCED_CRAFTING_TABLE,
        new ItemStack[] {null, new ItemStack(Material.WATER_BUCKET), null, SlimefunItems.ELECTRO_MAGNET, SlimefunItems.ELECTRIC_GOLD_PAN, SlimefunItems.ELECTRO_MAGNET, /*SlimefunItems.COPPER_INGO*/ new ItemStack(Material.COPPER_INGOT), /*SlimefunItems.COPPER_INGO*/ new ItemStack(Material.COPPER_INGOT), /*SlimefunItems.COPPER_INGO*/ new ItemStack(Material.COPPER_INGOT)},
                    44,1049,new int[]{20, 21}, new int[]{25, 26},270,"pickaxe")
        .setCapacity(128)
        .setEnergyConsumption(3)
        .setProcessingSpeed(1)
        .register(plugin);
        ...
        new ItemStack[] {null, new ItemStack(Material.WATER_BUCKET), null, SlimefunItems.ELECTRO_MAGNET, SlimefunItems.ELECTRIC_DUST_WASHER, SlimefunItems.ELECTRO_MAGNET, SlimefunItems.DAMASCUS_STEEL_INGOT, SlimefunItems.DAMASCUS_STEEL_INGOT, SlimefunItems.DAMASCUS_STEEL_INGOT}, 44, 1055, new int[]{20, 21}, new int[]{25, 26}, 270, "pickaxe")
        .setCapacity(128)
        .setEnergyConsumption(5)
        .setProcessingSpeed(2)
        .register(plugin);
        ...
        new ItemStack[] {null, new ItemStack(Material.WATER_BUCKET), null, SlimefunItems.ELECTRO_MAGNET, SlimefunItems.ELECTRIC_DUST_WASHER_2, SlimefunItems.ELECTRO_MAGNET, SlimefunItems.CORINTHIAN_BRONZE_INGOT, SlimefunItems.BLISTERING_INGOT_3, SlimefunItems.CORINTHIAN_BRONZE_INGOT}, 44, 1058, new int[]{20, 21}, new int[]{25, 26}, 270, "pickaxe")
        .setCapacity(512)
        ...
        new ItemStack[] {null, new ItemStack(Material.FLINT_AND_STEEL), null, SlimefunItems.HEATING_COIL, SlimefunItems.ELECTRIC_DUST_WASHER, SlimefunItems.HEATING_COIL, SlimefunItems.DAMASCUS_STEEL_INGOT, SlimefunItems.ELECTRIC_MOTOR, SlimefunItems.DAMASCUS_STEEL_INGOT}, 44, 1070, new int[]{20, 21}, new int[]{25, 26}, 270, "pickaxe")
        .setCapacity(256)
        ...
        new ItemStack[] {SlimefunItems.GILDED_IRON, new ItemStack(Material.FLINT_AND_STEEL), SlimefunItems.GILDED_IRON, SlimefunItems.HEATING_COIL, SlimefunItems.ELECTRIC_INGOT_FACTORY, SlimefunItems.HEATING_COIL, SlimefunItems.BRASS_INGOT, SlimefunItems.ELECTRIC_MOTOR, SlimefunItems.BRASS_INGOT}, 44, 1161, new int[]{20, 21}, new int[]{25, 26}, 270, "pickaxe")
        .setCapacity(256)
        .setEnergyConsumption(7)
        .setProcessingSpeed(2)
        .register(plugin);
        ...
        new ItemStack[] {SlimefunItems.GILDED_IRON, new ItemStack(Material.FLINT_AND_STEEL), SlimefunItems.GILDED_IRON, SlimefunItems.HEATING_COIL, SlimefunItems.ELECTRIC_INGOT_FACTORY_2, SlimefunItems.HEATING_COIL, SlimefunItems.BRASS_INGOT, SlimefunItems.BLISTERING_INGOT_3, SlimefunItems.BRASS_INGOT}, 44, 1164, new int[]{20, 21}, new int[]{25, 26}, 270, "pickaxe")
        .setCapacity(512)
        .setEnergyConsumption(20)
        .setProcessingSpeed(5)//(8)
        .register(plugin);
        ...
        new ItemStack[] {null, new ItemStack(Material.DIAMOND_PICKAXE), null, SlimefunItems.GILDED_IRON, SlimefunItems.HEATING_COIL, SlimefunItems.GILDED_IRON, SlimefunItems.GILDED_IRON, SlimefunItems.ELECTRIC_MOTOR, SlimefunItems.GILDED_IRON}, 44, 1082, new int[]{29,30 }, new int[]{25, 26}, 270, "pickaxe")
        .setCapacity(128)
        ...
        new ItemStack[] {null, new ItemStack(Material.DIAMOND_PICKAXE), null, SlimefunItems.HEATING_COIL, SlimefunItems.ELECTRIC_ORE_GRINDER, SlimefunItems.HEATING_COIL, SlimefunItems.GILDED_IRON, SlimefunItems.BLISTERING_INGOT_3, SlimefunItems.GILDED_IRON}, 44, 1155, new int[]{29,30 }, new int[]{25, 26}, 270, "pickaxe")
        .setCapacity(512)
        .setEnergyConsumption(15)
        .setProcessingSpeed(2)//(4)
        .register(plugin);

        new ElectricOreGrinder(categories.electricity, SlimefunItems.ELECTRIC_ORE_GRINDER_3, RecipeType.ENHANCED_CRAFTING_TABLE,
        new ItemStack[] {SlimefunItems.REINFORCED_PLATE, SlimefunItems.HEATING_COIL, SlimefunItems.REINFORCED_PLATE, null, SlimefunItems.ELECTRIC_ORE_GRINDER_2, null, SlimefunItems.REINFORCED_PLATE, SlimefunItems.BLISTERING_INGOT_3, SlimefunItems.REINFORCED_PLATE}, 44, 1155, new int[]{29,30 }, new int[]{25, 26}, 270, "pickaxe")
        .setCapacity(1024)
        .setEnergyConsumption(45)
        .setProcessingSpeed(4)//(10)
        .register(plugin);
        ...
        new ItemStack[] {null, SlimefunItems.ELECTRIC_ORE_GRINDER, null, SlimefunItems.LEAD_INGOT, SlimefunItems.MEDIUM_CAPACITOR, SlimefunItems.LEAD_INGOT, SlimefunItems.LEAD_INGOT, SlimefunItems.HEATING_COIL, SlimefunItems.LEAD_INGOT},
                44, 1094, new int[]{ 11,12 }, new int[]{25, 26}, 270, "pickaxe")
        .setCapacity(512)
        .setEnergyConsumption(7)
        .setProcessingSpeed(1)
        .register(plugin);
        ...
        new ItemStack[] {SlimefunItems.HEATING_COIL, new ItemStack(Material.FURNACE), SlimefunItems.HEATING_COIL, SlimefunItems.NICKEL_INGOT, SlimefunItems.ELECTRIC_MOTOR, SlimefunItems.NICKEL_INGOT, null, SlimefunItems.NICKEL_INGOT, null},
                44, 1096, new int[]{ 11,12 }, new int[]{25, 26}, 270, "pickaxe")
        .setCapacity(64)
        ...
        new ItemStack[] {new ItemStack(Material.MAGMA_BLOCK), SlimefunItems.HEATING_COIL, new ItemStack(Material.MAGMA_BLOCK), SlimefunItems.HARDENED_METAL_INGOT, SlimefunItems.COAL_GENERATOR, SlimefunItems.HARDENED_METAL_INGOT, null, SlimefunItems.ELECTRIC_MOTOR, null},
                44, 1098, new int[]{ 11,12 }, new int[]{25, 26}, 270, "pickaxe")
        .setCapacity(256)
        ...
        new ItemStack[] {/*SlimefunItems.COPPER_INGO*/ new ItemStack(Material.COPPER_INGOT), null, /*SlimefunItems.COPPER_INGO*/ new ItemStack(Material.COPPER_INGOT), null, SlimefunItems.REDSTONE_ALLOY, null, null, SlimefunItems.GOLD_6K, null})
        .register(plugin);
        ...
        new SlimefunItemStack(SlimefunItems.WITHER_PROOF_GLASS, 4), 370, "pickaxe")
        .register(plugin);
