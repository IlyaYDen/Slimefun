...
public class AncientPedestal extends SimpleSlimefunItem<BlockDispenseHandler> {
    ...
    public static final String ITEM_PREFIX = ChatColors.color("&dАЛТАРЬ &3Проба - &e");
    ...
    public void placeItem(@Nonnull Player p, @Nonnull Block b) {
        ...
        //TranslatableComponent nametag = new TranslatableComponent("item.minecraft."+hand.getType().toString().toLowerCase());
        ...
        entity.setCustomName(nametag);//{CustomName:"{\"translate\":\"language.name\",\"color\":\"white\"}"}
