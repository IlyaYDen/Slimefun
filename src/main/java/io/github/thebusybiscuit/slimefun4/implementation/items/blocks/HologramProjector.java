...
public class HologramProjector extends SlimefunItem implements HologramOwner {
    ...
    private BlockPlaceHandler onPlace() {
        return new BlockPlaceHandler(false) {
            ...
            public void onPlayerPlace(BlockPlaceEvent e) {
                ...
                BlockStorage.addBlockInfo(b, "text", "Правый клик для изменения текста");
    ...
    private static void openEditor(@Nonnull Player p, @Nonnull Block projector) {
        ...
        menu.addItem(0, new CustomItem(Material.NAME_TAG, "&7Текст &e(Нажмите, чтобы изменить)", "", "&r" + ChatColors.color(BlockStorage.getLocationInfo(projector.getLocation(), "text"))));
        ...
        menu.addItem(1, new CustomItem(Material.CLOCK, "&7Смещение: &e" + NumberUtils.roundDecimalNumber(Double.valueOf(BlockStorage.getLocationInfo(projector.getLocation(), OFFSET_PARAMETER)) + 1.0D), "", "&rЛевый Клик: &7+0.1", "&rПравый Клик: &7-0.1"));
