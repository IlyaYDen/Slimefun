...
public class ElectricIngotPulverizer extends AContainer implements RecipeDisplayItem, NotHopperable {
    ...
    public ElectricIngotPulverizer(Category category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe, int slot, int cmd, int[] in, int[] out,int t,String st) {
    ...
    protected void registerDefaultRecipes() {
        ...
        registerRecipe(5, new ItemStack(Material.GOLD_INGOT), SlimefunItems.GOLD_DUST);

        if (SlimefunPlugin.getMinecraftVersion().isAtLeast(MinecraftVersion.MINECRAFT_1_17)) {
            registerRecipe(5, new ItemStack(Material.COPPER_INGOT), SlimefunItems.COPPER_DUST);
        }
    }
