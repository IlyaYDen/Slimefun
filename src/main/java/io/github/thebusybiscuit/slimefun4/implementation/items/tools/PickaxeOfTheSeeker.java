                ...
                for (int z = -range; z <= range; z++) {
                    ...
                    if (SlimefunTag.PICKAXE_OF_THE_SEEKER_BLOCKS.isTagged(block.getType())) {
                        ...
                        if (closest == null || distance < lastDistance) {
                            ...
                            block.getType().equals(Material.QUARTZ_SLAB)|       // ALUMINIUM_ORE
                                    block.getType().equals(Material.STONE_BRICK_SLAB)|  // SILVER_ORE
                                    block.getType().equals(Material.STONE_SLAB)|        // NICKEL_ORE
                                    block.getType().equals(Material.SANDSTONE_SLAB)|    // TIN_ORE
                                    block.getType().equals(Material.NETHER_BRICK_SLAB))) {

                        Slab blocks = (Slab) block.getBlockData();
                        if (blocks.getType().equals(Slab.Type.DOUBLE)) closest = block;
