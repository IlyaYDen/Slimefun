...
public class ChargingBench extends AContainer {
    ...
    public ChargingBench(Category category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe, int t, String st) {
        //super(category, item, recipeType, recipe,t,st); edited
