...
public abstract class AbstractMonsterSpawner extends SlimefunItem {
    ...
    public Optional<EntityType> getEntityType(@Nonnull ItemStack item) {
        ...
        for (String line : meta.getLore()) {
            if (ChatColor.stripColor(line).startsWith("Тип: ") && !line.contains("<Type>")) {
                EntityType type = EntityType.valueOf(ChatColor.stripColor(line).replace("Тип: ", "").replace(' ', '_').toUpperCase(Locale.ROOT));
