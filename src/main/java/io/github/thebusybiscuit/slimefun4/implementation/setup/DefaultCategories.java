...
import io.github.thebusybiscuit.slimefun4.core.categories.*;
...
class DefaultCategories {
    ...
    protected final CreativeCategory TEST = new CreativeCategory(new NamespacedKey(SlimefunPlugin.instance(), "test"),new ItemStack(Material.ARMOR_STAND));
        //new SubCategory(new NamespacedKey(SlimefunPlugin.instance(), "test"),null,new ItemStack(Material.ACACIA_BOAT));
