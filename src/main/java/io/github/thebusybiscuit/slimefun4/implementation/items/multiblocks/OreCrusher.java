...
public class OreCrusher extends MultiBlockMachine {
    ...
    public OreCrusher(Category category, SlimefunItemStack item) {
        super(category, item, new ItemStack[] { null, null, null, null, new ItemStack(Material.NETHER_BRICK_FENCE), null, new ItemStack(Material.IRON_BARS), new CustomItem(Material.DISPENSER, "Раздатчик (Смотрит вверх)"), new ItemStack(Material.IRON_BARS) }, BlockFace.SELF);
    ...
    protected void registerDefaultRecipes(List<ItemStack> recipes) {
        ...
        recipes.add(new CustomItem(Material.COPPER_ORE));
        recipes.add(new SlimefunItemStack(SlimefunItems.COPPER_DUST, 2));

        recipes.add(SlimefunItems.LEAD_ORE);
        recipes.add(new SlimefunItemStack(SlimefunItems.LEAD_DUST, 2));

        recipes.add(SlimefunItems.SILVER_ORE);
        recipes.add(new SlimefunItemStack(SlimefunItems.SILVER_DUST, 2));

        recipes.add(SlimefunItems.TIN_ORE);
        recipes.add(new SlimefunItemStack(SlimefunItems.TIN_DUST, 2));
    }
