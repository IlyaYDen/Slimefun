...
public class MinerAndroid extends ProgrammableAndroid {
    ...
    protected void dig(Block b, BlockMenu menu, Block block) {
        ...
        if(block.getType().toString().contains("_SLAB") ) {
            ...
            Slab blocks = (Slab) block.getBlockData();
            if (blocks.getType().equals(Slab.Type.DOUBLE)) {
                if (type.equals(Material.BRICK_SLAB)) {
                    drops.clear();
                    drops.add(SlimefunItems.LEAD_ORE);      // LEAD_ORE
                }
                else if (type.equals(Material.QUARTZ_SLAB)) {
                    drops.clear();
                    drops.add(SlimefunItems.ALUMINIUM_ORE);     // ALUMINIUM_ORE
                }
                else if (type.equals(Material.STONE_BRICK_SLAB)) {
                    drops.clear();
                    drops.add(SlimefunItems.LEAD_ORE);  // SILVER_ORE
                }
                else if (type.equals(Material.STONE_SLAB)) {
                    drops.clear();
                    drops.add(SlimefunItems.NICKEL_ORE);     // NICKEL_ORE
                }
                else if (type.equals(Material.SANDSTONE_SLAB)) {
                    drops.clear();
                    drops.add(SlimefunItems.TIN_ORE);     // NICKEL_ORE
                }
                else if (type.equals(Material.NETHER_BRICK_SLAB)){
                    drops.clear();
                    drops.add(SlimefunItems.URANIUM);     // NICKEL_ORE
                }
               // else
               //     drops = block.getDrops(effectivePickaxe);
            }
        }
