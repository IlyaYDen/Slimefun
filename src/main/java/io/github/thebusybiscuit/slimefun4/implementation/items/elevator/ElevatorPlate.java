...
public class ElevatorPlate extends SimpleSlimefunItem<BlockUseHandler> {
    ...
    public void openEditor(Player p, Block b) {
        ChestMenu menu = new ChestMenu("Настройки Лифта");

        menu.addItem(4, new CustomItem(Material.NAME_TAG, "&7Название этажа &e(Нажмите, чтобы изменить)", "", ChatColor.WHITE + ChatColors.color(BlockStorage.getLocationInfo(b.getLocation(), DATA_KEY))));
