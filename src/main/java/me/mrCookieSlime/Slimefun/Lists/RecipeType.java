...
public class RecipeType implements Keyed {
    ...
    //edited
    public static final RecipeType ORE_DROP = new RecipeType(new NamespacedKey(SlimefunPlugin.instance(), "ore_drop"), new CustomItem(Material.DIAMOND_PICKAXE, "&bДобывается в шахте", "", "&rВы можете добыть этот ресурс в шахте"));
    //edited end
